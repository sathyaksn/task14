                ...
                <div className="col mb-5">
                    <div className="card h-100">
                        ...
                        <div className="card-footer p-4 pt-0 border-top-0 bg-transparent" >
                            <div className="text-center"><button className="btn btn-outline-dark mt-auto" href="#cart" id={notes.id} onClick={() => Handleevent(notes.id)}>{notes.name2}</button></div>
                        </div>
                    </div>
                </div>
            )
                ...
                <div className="col mb-5">
                    <div className="card h-100">
                        ...
                        <div className="card-footer p-4 pt-0 border-top-0 ">
                            <div className="text-center"><a className="btn btn-outline-dark mt-auto" id={notes.id} href="#addcart">{notes.name2}</a></div>
                        </div>
                    </div>
                </div>
            )
